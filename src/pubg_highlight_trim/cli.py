...
def build_parser() -> argparse.ArgumentParser:
    ...
    ocr.add_argument("--adaptive-step", type=parse_nonnegative_float, default=0.5, help="Seconds between samples after a coarse target hit")
    ocr.add_argument("--adaptive-window", type=parse_nonnegative_float, default=2.0, help="Seconds after a coarse target hit to sample adaptively")
