...
def build_parser() -> argparse.ArgumentParser:
    ...
    ocr.add_argument("--roi", type=parse_roi, default=(0.22, 0.62, 0.78, 0.84), help="OCR crop ratios x1,y1,x2,y2")
    ocr.add_argument("--ocr-width", type=int, default=1152, help="Downscale OCR ROI to this width; 0 disables")
