...
LANGUAGE_REGEX_TABLES = (
    ...
    LanguageRegexTable(
        ...
        zone_self_terms=(
            r"您.{0,4}(?:安全區|遊戲區域)外(?:倒地|死亡)",
            r"您在安全区外倒地了",
            r"您因.{0,8}(?:墜落|跌落|摔落).{0,4}擊倒",
        ),
        ...
        own_kill_source_terms=(r"單次擊殺", r"雙殺", r"多殺", r"多重擊殺", r"擊倒"),
        multi_kill_source_terms=(r"雙殺", r"多殺", r"多重擊殺"),
        match_end_source_terms=(r"對戰結束",),
        view_replay_terms=(r"死亡畫面", r"淘汰畫面", r"擊倒畫面"),
        source_file_hint=".被擊倒.DVR*.mp4, .死亡.DVR*.mp4, .淘汰.DVR*.mp4, .單次擊殺.DVR*.mp4, .雙殺.DVR*.mp4, .多重擊殺.DVR*.mp4, .擊倒.DVR*.mp4, .對戰結束.DVR*.mp4",
    ...
    LanguageRegexTable(
        ...
        zone_self_terms=(
            ...
            r"YOUWEREKNOCKEDOUTBY(?:FALLING|FALLDAMAGE)",
            r"YOUWEREKNOCKEDOUTFROMFALLING",
            r"YOUDIEDFROMFALLING",
        ),
